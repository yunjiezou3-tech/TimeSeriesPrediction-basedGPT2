...
#         # self.time_embed_proj = torch.nn.Linear(4096, 768) # 预训练的pt模型shape为[.., 4096], 适配llama模型，gpt2要做一个线性变换对齐维度
#
#         if self.mix:
...
#             # times_embeds = times_embeds + self.add_scale * self.time_embed_proj(x_mark_enc)
